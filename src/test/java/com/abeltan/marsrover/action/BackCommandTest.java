...
class BackCommandTest {
    ...
    @Test
    void testThatNorthFacingRoverMovesByOneAlongNegativeYAxis() {
        Rover r = new Rover(new Coordinate(0, 0), Direction.NORTH);
        Command command = new BackCommand(r);
        command.execute();
    ...
    @Test
    void testThatSouthFacingRoverMovesByOneAlongPositiveYAxis() {
    ...
    @Test
    void testThatEastFacingRoverMovesByOneAlongNegativeXAxis() {
    ...
    @Test
    void testThatWestFacingRoverMovesByOneAlongPositiveXAxis() {
