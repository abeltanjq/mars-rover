...
class LeftCommandTest {
    ...
    @Test
    void testThatNorthFacingRoverRotatesToWest() {
        Rover r = new Rover(new Coordinate(0, 0), Direction.NORTH);
        Command command = new LeftCommand(r);
        command.execute();
    ...
    @Test
    void testThatSouthFacingRoverRotatesToEast() {
    ...
    @Test
    void testThatEastFacingRoverRoverRotatesToNorth() {
    ...
    @Test
    void testThatWestFacingRoverRoverRotatesToSouth() {
