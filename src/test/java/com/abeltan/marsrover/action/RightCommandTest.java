...
class RightCommandTest {
    ...
    @Test
    void testThatNorthFacingRoverRotatesToEast() {
        Rover r = new Rover(new Coordinate(0, 0), Direction.NORTH);
        Command command = new RightCommand(r);
        command.execute();
    ...
    @Test
    void testThatSouthFacingRoverRotatesToWest() {
    ...
    @Test
    void testThatEastFacingRoverRoverRotatesToSouth() {
    ...
    @Test
    void testThatWestFacingRoverRoverRotatesToNorth() {
